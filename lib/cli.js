...
class CLI {
            ...
            .prompt([
                {
                    type: 'input',
                    name: 'fileTitle',
                    message: "Please enter file name you'd like for this .SVG file."
                }
            ])
            .then(({ fileTitle }) => {
                this.fileTitle = fileTitle;
                return this.initialsGather();
            })
    }
    initialsGather() {
        return inquirer
    ...
    reviewSelections() {
        console.log(`File Title: ${this.fileTitle}.svg`)
        ...
        return inquirer
            ...
            .then(({ confirm }) => {
                if (confirm) {
                    console.log(`Generated ${this.fileTitle}.svg`)
                    return writeFile(
                        join(__dirname, '..', 'examples', `${this.fileTitle}.svg`),
                        createSVG(this.initials, this.textColor, this.shape, this.backgroundColor)
                    );
                } else {
